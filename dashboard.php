            ...
            <div class="levels">
                <a href="./beginner/" target="_blank" id="level">
                    <div class="level beginner">
                        ...
                        <p>Learn the basics of computer which includes turning it on, etc.</p>
                    </div>
                    </a>
                ...
                <a href="./intermediate/" target="_blank" id="level">
                    <div class="level intermediate">
                        ...
                        <p>Get to know the basics of Microsift Office an its use.</p>
                    </div>
                </a>
                ...
                <a href="./advanced/" target="_blank" id="level">
                    <div class="level advanced">
                        ...
                        <p>More on microsoft office and some advanced computer stuffs.</p>
                    </div>
                </a>
            </div>
        </div>
