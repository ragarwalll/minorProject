    ...
    <div id="guts">
        <div class="container--con">
            <div class="person" style="margin-left:100px;">
                <div class="name">
                    <p id="name--social">Harshit Dugar</p>
                </div>
                <div class="social">
                    ...
                    <a href="http://127.0.0.1/miniProject/messenger.php?to=harshit"><i class="far fa-comment social1"></i></a>
                </div>
                <div class="picture">
                    <img src="./img/harshit.jpg" width="110" alt="" class="dp">
                </div>
            </div>
            <div class="person" style="margin-right:50px;">
                <div class="name">
                    <p id="name--social">Bhavi Doshi</p>
                </div>
                <div class="social">
                    ...
                    <a href="http://127.0.0.1/miniProject/messenger.php?to=bhavi"><i class="far fa-comment social1"></i></a>
                </div>
                <div class="picture">
            ...
            <div class="person" style="margin-left:100px;">
                <div class="name">
                    <p id="name--social">Rahul Agarwal</p>
                </div>
                <div class="social">
                    ...
                    <a href="http://127.0.0.1/miniProject/messenger.php?to=rahul78649"><i class="far fa-comment social1"></i></a>   
                </div>
                <div class="picture">
