...
<body>
    ...
    <div id="container" class="top">    
        ...
        <div class="paging">
            ...
            <a href="2.php" class="pageInc pageInc1">Next <i class="fas fa-chevron-circle-right ico"></i></a>
        </div>
        ...
        <div class="main-wrapper beginner-content">
           <div class="card"> 
                <div class="heading">
                    <p> Before getting started with the actual tutorial, let us first learn what computers are about.</p>
                </div>
            </div>
            <br><br>
            ...
            <div class="center answer">
                <img src="../img/computer.jpg" width="200" alt="">
            </div>
